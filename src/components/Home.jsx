    ...
    <main className="main-content">
      ...
      <section className="section" id="blog">
        ...
        <div className="blog-grid">
          <Link to="/blog/react-native-setup-2025" className="blog-card">
          ...
          <Link to="/blog/flatlist-optimization" className="blog-card">
            <div className="blog-content">
          ...
          <Link to="/blog/pure-components" className="blog-card">
            <div className="blog-content">
          ...
          <Link to="/blog" className="blog-card">
            <div className="blog-content">
              <h3 className="blog-title">View All Posts</h3>
              <p className="blog-excerpt">
                Explore my complete collection of technical articles covering React Native development, performance optimization, and best practices.
              </p>
              <p className="blog-meta">Updated regularly</p>
            </div>
          </Link>
        </div>
      </section>
